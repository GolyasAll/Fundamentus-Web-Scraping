...
def main():
    ...
    num_paper = int(input("Quantos FII's você deseja consultar? "))
    ...
    for _ in range(num_paper):
        code_paper = input("Digite o Código dos FII's: ").upper()
    ...
    if table:
        ...
        for paper in papers_consulted:
            ...
            if paper_data:
                ...
                print(f"Dados não encontrados para o FII {paper}")
        ...
        if data_papers:
            ...
            df.to_excel("data_papers_fii.xlsx", index=False)
